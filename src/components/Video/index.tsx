...
const Video = () => {
  ...
  return (
    <section className="relative z-10 py-16 md:py-20 lg:py-28" id="first-section">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-[-1] h-full w-full bg-[url(/images/video/Program-overview.png)] bg-cover bg-fixed bg-center bg-no-repeat"></div>
    </section>
  );
};
